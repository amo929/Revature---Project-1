...
import reimburse.log4jstuff.Main;
...
public class ReimbEmployeeDAOImpl implements ReimbDAO {
	...
	public ArrayList<Reimbursement> getAll(int id) {
		...
		try(Connection conn = ConnectionFactory.getInstance().getConnection();){
			...
			e.printStackTrace();
			log.error("SQLException at getAll() for the ReimbEmployeeDAO");
		}
		return list;
	}
	...
	public void insertTicket(double amount, String description, User author, String type) {
